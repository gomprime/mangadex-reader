...
void BrowseTab::loadPage(bool reset)
{
    ...
    util::spawnWorkerThread([this, aliveCopy, requestMode, requestOffset]() {
        ...
        api::SearchResult result = (requestMode == Mode::Latest)
            ? api::MangaDexClient::GetLatestUpdates(requestOffset, kPageSize, settings.contentRatings, settings.preferredLanguage)
            : api::MangaDexClient::GetPopular(requestOffset, kPageSize, settings.contentRatings, settings.preferredLanguage);
